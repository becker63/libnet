...
const
  NFQ_XML_HW* = cuint(1)
const
  NFQ_XML_MARK* = cuint(2)
const
  NFQ_XML_DEV* = cuint(4)
const
  NFQ_XML_PHYSDEV* = cuint(8)
const
  NFQ_XML_PAYLOAD* = cuint(16)
const
  NFQ_XML_TIME* = cuint(32)
const
  NFQ_XML_UID* = cuint(64)
const
  NFQ_XML_GID* = cuint(128)
const
  NFQ_XML_SECCTX* = cuint(256)
const
  NFQ_XML_ALL* = cuint(-1)
const
...
type
  enum_itimer_which* {.size: sizeof(cuint).} = enum
...
type
  enum_nfqnl_msg_types* {.size: sizeof(cuint).} = enum
    NFQNL_MSG_PACKET = 0, NFQNL_MSG_VERDICT = 1, NFQNL_MSG_CONFIG = 2,
    NFQNL_MSG_VERDICT_BATCH = 3, NFQNL_MSG_MAX = 4
type
  enum_nfqnl_attr_type* {.size: sizeof(cuint).} = enum
    NFQA_UNSPEC = 0, NFQA_PACKET_HDR = 1, NFQA_VERDICT_HDR = 2, NFQA_MARK = 3,
    NFQA_TIMESTAMP = 4, NFQA_IFINDEX_INDEV = 5, NFQA_IFINDEX_OUTDEV = 6,
    NFQA_IFINDEX_PHYSINDEV = 7, NFQA_IFINDEX_PHYSOUTDEV = 8, NFQA_HWADDR = 9,
    NFQA_PAYLOAD = 10, NFQA_CT = 11, NFQA_CT_INFO = 12, NFQA_CAP_LEN = 13,
    NFQA_SKB_INFO = 14, NFQA_EXP = 15, NFQA_UID = 16, NFQA_GID = 17,
    NFQA_SECCTX = 18, compiler_NFQA_MAX = 19
type
  enum_nfqnl_msg_config_cmds* {.size: sizeof(cuint).} = enum
    NFQNL_CFG_CMD_NONE = 0, NFQNL_CFG_CMD_BIND = 1, NFQNL_CFG_CMD_UNBIND = 2,
    NFQNL_CFG_CMD_PF_BIND = 3, NFQNL_CFG_CMD_PF_UNBIND = 4
type
  enum_nfqnl_config_mode* {.size: sizeof(cuint).} = enum
    NFQNL_COPY_NONE = 0, NFQNL_COPY_META = 1, NFQNL_COPY_PACKET = 2
type
  enum_nfqnl_attr_config* {.size: sizeof(cuint).} = enum
    NFQA_CFG_UNSPEC = 0, NFQA_CFG_CMD = 1, NFQA_CFG_PARAMS = 2,
    NFQA_CFG_QUEUE_MAXLEN = 3, NFQA_CFG_MASK = 4, NFQA_CFG_FLAGS = 5,
    compiler_NFQA_CFG_MAX = 6
type
...
type
  ...
  suseconds_t* = compiler_suseconds_t ## Generated based on /nix/store/sh3sjmgq543lfpjsq3dc0ksb6ckvhpdi-glibc-2.40-66-dev/include/sys/time.h:28:23
  ...
  struct_timezone* {.pure, inheritable, bycopy.} = object
    tz_minuteswest*: cint    ## Generated based on /nix/store/sh3sjmgq543lfpjsq3dc0ksb6ckvhpdi-glibc-2.40-66-dev/include/sys/time.h:52:8
    tz_dsttime*: cint
  struct_itimerval* {.pure, inheritable, bycopy.} = object
    it_interval*: struct_timeval ## Generated based on /nix/store/sh3sjmgq543lfpjsq3dc0ksb6ckvhpdi-glibc-2.40-66-dev/include/sys/time.h:130:8
    it_value*: struct_timeval
  compiler_itimer_which_t* = cint ## Generated based on /nix/store/sh3sjmgq543lfpjsq3dc0ksb6ckvhpdi-glibc-2.40-66-dev/include/sys/time.h:143:13
  ...
  struct_nfattr* {.pure, inheritable, bycopy.} = object
    nfa_len*: compiler_u16   ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/linux_nfnetlink_compat.h:23:8
  ...
  struct_nfgenmsg* {.pure, inheritable, bycopy.} = object
    nfgen_family*: compiler_u8 ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/linux_nfnetlink.h:27:8
    version*: compiler_u8
  ...
  struct_nfnlhdr* {.pure, inheritable, bycopy.} = object
    nlh*: struct_nlmsghdr    ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/libnfnetlink.h:55:8
  ...
  struct_nfnl_callback* {.pure, inheritable, bycopy.} = object
    call*: proc (a0: ptr struct_nlmsghdr;
        ...
        cdecl.}              ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/libnfnetlink.h:60:8
    data*: pointer
    attr_count*: uint16
  ...
  struct_nfqnl_msg_packet_hdr* {.pure, inheritable, bycopy, packed.} = object
    packet_id*: compiler_be32 ## Generated based on /nix/store/096caq1dwaql303f6cdfp1ky2marpanh-libnetfilter_queue-1.0.5/include/libnetfilter_queue/linux_nfnetlink_queue.h:20:8
    hw_protocol*: compiler_be16
    hook*: compiler_u8
  compiler_be32* = compiler_u32 ## Generated based on /nix/store/sh3sjmgq543lfpjsq3dc0ksb6ckvhpdi-glibc-2.40-66-dev/include/linux/types.h:34:25
  struct_nfqnl_msg_packet_hw* {.pure, inheritable, bycopy.} = object
    hw_addrlen*: compiler_be16 ## Generated based on /nix/store/096caq1dwaql303f6cdfp1ky2marpanh-libnetfilter_queue-1.0.5/include/libnetfilter_queue/linux_nfnetlink_queue.h:26:8
    internal_pad*: compiler_u16
    hw_addr*: array[8'i64, compiler_u8]
  struct_nfqnl_msg_packet_timestamp* {.pure, inheritable, bycopy.} = object
    sec*: compiler_be64      ## Generated based on /nix/store/096caq1dwaql303f6cdfp1ky2marpanh-libnetfilter_queue-1.0.5/include/libnetfilter_queue/linux_nfnetlink_queue.h:32:8
    usec*: compiler_be64
  compiler_be64* = compiler_u64 ## Generated based on /nix/store/sh3sjmgq543lfpjsq3dc0ksb6ckvhpdi-glibc-2.40-66-dev/include/linux/types.h:36:25
  struct_nfqnl_msg_verdict_hdr* {.pure, inheritable, bycopy.} = object
    verdict*: compiler_be32  ## Generated based on /nix/store/096caq1dwaql303f6cdfp1ky2marpanh-libnetfilter_queue-1.0.5/include/libnetfilter_queue/linux_nfnetlink_queue.h:62:8
    id*: compiler_be32
  struct_nfqnl_msg_config_cmd* {.pure, inheritable, bycopy.} = object
    command*: compiler_u8    ## Generated based on /nix/store/096caq1dwaql303f6cdfp1ky2marpanh-libnetfilter_queue-1.0.5/include/libnetfilter_queue/linux_nfnetlink_queue.h:76:8
    internal_pad*: compiler_u8
    pf*: compiler_be16
  struct_nfqnl_msg_config_params* {.pure, inheritable, bycopy, packed.} = object
    copy_range*: compiler_be32 ## Generated based on /nix/store/096caq1dwaql303f6cdfp1ky2marpanh-libnetfilter_queue-1.0.5/include/libnetfilter_queue/linux_nfnetlink_queue.h:88:8
    copy_mode*: compiler_u8
  nfq_callback* = proc (a0: ptr struct_nfq_q_handle; a1: ptr struct_nfgenmsg;
                        a2: ptr struct_nfq_data; a3: pointer): cint {.cdecl.} ## Generated based on /nix/store/096caq1dwaql303f6cdfp1ky2marpanh-libnetfilter_queue-1.0.5/include/libnetfilter_queue/libnetfilter_queue.h:34:14
  ...
  union_nf_inet_addr* {.union, bycopy.} = object
    all*: array[4'i64, compiler_u32] ## Generated based on /nix/store/sh3sjmgq543lfpjsq3dc0ksb6ckvhpdi-glibc-2.40-66-dev/include/linux/netfilter.h:68:7
    ip*: compiler_be32
  ...
  struct_in_addr* {.pure, inheritable, bycopy.} = object
    s_addr*: compiler_be32   ## Generated based on /nix/store/sh3sjmgq543lfpjsq3dc0ksb6ckvhpdi-glibc-2.40-66-dev/include/linux/in.h:94:8
  ...
  struct_in6_addr* {.pure, inheritable, bycopy.} = object
    in6_u*: struct_in6_addr_in6_u_t ## Generated based on /nix/store/sh3sjmgq543lfpjsq3dc0ksb6ckvhpdi-glibc-2.40-66-dev/include/linux/in6.h:33:8
  ...
  compiler_u64* = culonglong ## Generated based on /nix/store/sh3sjmgq543lfpjsq3dc0ksb6ckvhpdi-glibc-2.40-66-dev/include/asm-generic/int-ll64.h:31:42
when 1 is static:
  const
    internal_SYS_TIME_H* = 1 ## Generated based on /nix/store/sh3sjmgq543lfpjsq3dc0ksb6ckvhpdi-glibc-2.40-66-dev/include/sys/time.h:19:9
else:
  let internal_SYS_TIME_H* = 1 ## Generated based on /nix/store/sh3sjmgq543lfpjsq3dc0ksb6ckvhpdi-glibc-2.40-66-dev/include/sys/time.h:19:9
when 1 is static:
  const
...
when 1 is static:
  const
    NF_NETLINK_CONNTRACK_NEW* = 1 ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/linux_nfnetlink_compat.h:9:9
else:
  let NF_NETLINK_CONNTRACK_NEW* = 1 ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/linux_nfnetlink_compat.h:9:9
when 2 is static:
  const
    NF_NETLINK_CONNTRACK_UPDATE* = 2 ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/linux_nfnetlink_compat.h:10:9
else:
  let NF_NETLINK_CONNTRACK_UPDATE* = 2 ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/linux_nfnetlink_compat.h:10:9
when 4 is static:
  const
    NF_NETLINK_CONNTRACK_DESTROY* = 4 ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/linux_nfnetlink_compat.h:11:9
else:
  let NF_NETLINK_CONNTRACK_DESTROY* = 4 ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/linux_nfnetlink_compat.h:11:9
when 8 is static:
  const
    NF_NETLINK_CONNTRACK_EXP_NEW* = 8 ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/linux_nfnetlink_compat.h:12:9
else:
  let NF_NETLINK_CONNTRACK_EXP_NEW* = 8 ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/linux_nfnetlink_compat.h:12:9
when 16 is static:
  const
    NF_NETLINK_CONNTRACK_EXP_UPDATE* = 16 ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/linux_nfnetlink_compat.h:13:9
else:
  let NF_NETLINK_CONNTRACK_EXP_UPDATE* = 16 ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/linux_nfnetlink_compat.h:13:9
when 32 is static:
  const
    NF_NETLINK_CONNTRACK_EXP_DESTROY* = 32 ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/linux_nfnetlink_compat.h:14:9
else:
  let NF_NETLINK_CONNTRACK_EXP_DESTROY* = 32 ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/linux_nfnetlink_compat.h:14:9
when 32768 is static:
  const
    NFNL_NFA_NEST* = 32768   ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/linux_nfnetlink_compat.h:32:9
else:
  let NFNL_NFA_NEST* = 32768 ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/linux_nfnetlink_compat.h:32:9
when 4 is static:
  const
    NFA_ALIGNTO* = 4         ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/linux_nfnetlink_compat.h:35:9
else:
  let NFA_ALIGNTO* = 4       ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/linux_nfnetlink_compat.h:35:9
when 0 is static:
  const
    NFNETLINK_V0* = 0        ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/linux_nfnetlink.h:33:9
else:
  let NFNETLINK_V0* = 0      ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/linux_nfnetlink.h:33:9
when 0 is static:
  const
    NFNL_SUBSYS_NONE* = 0    ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/linux_nfnetlink.h:44:9
else:
  let NFNL_SUBSYS_NONE* = 0  ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/linux_nfnetlink.h:44:9
when 1 is static:
  const
    NFNL_SUBSYS_CTNETLINK* = 1 ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/linux_nfnetlink.h:45:9
else:
  let NFNL_SUBSYS_CTNETLINK* = 1 ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/linux_nfnetlink.h:45:9
when 2 is static:
  const
    NFNL_SUBSYS_CTNETLINK_EXP* = 2 ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/linux_nfnetlink.h:46:9
else:
  let NFNL_SUBSYS_CTNETLINK_EXP* = 2 ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/linux_nfnetlink.h:46:9
when 3 is static:
  const
    NFNL_SUBSYS_QUEUE* = 3   ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/linux_nfnetlink.h:47:9
else:
  let NFNL_SUBSYS_QUEUE* = 3 ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/linux_nfnetlink.h:47:9
when 4 is static:
  const
    NFNL_SUBSYS_ULOG* = 4    ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/linux_nfnetlink.h:48:9
else:
  let NFNL_SUBSYS_ULOG* = 4  ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/linux_nfnetlink.h:48:9
when 5 is static:
  const
    NFNL_SUBSYS_OSF* = 5     ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/linux_nfnetlink.h:49:9
else:
  let NFNL_SUBSYS_OSF* = 5   ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/linux_nfnetlink.h:49:9
when 6 is static:
  const
    NFNL_SUBSYS_IPSET* = 6   ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/linux_nfnetlink.h:50:9
else:
  let NFNL_SUBSYS_IPSET* = 6 ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/linux_nfnetlink.h:50:9
when 7 is static:
  const
    NFNL_SUBSYS_COUNT* = 7   ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/linux_nfnetlink.h:51:9
else:
  let NFNL_SUBSYS_COUNT* = 7 ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/linux_nfnetlink.h:51:9
when 4 is static:
  const
    NETLINK_BROADCAST_SEND_ERROR* = 4 ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/libnfnetlink.h:32:9
else:
  let NETLINK_BROADCAST_SEND_ERROR* = 4 ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/libnfnetlink.h:32:9
when 8192 is static:
  const
    NFNL_BUFFSIZE* = 8192    ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/libnfnetlink.h:45:9
else:
  let NFNL_BUFFSIZE* = 8192  ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/libnfnetlink.h:45:9
when 16 is static:
  const
    IFNAMSIZ* = 16           ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/libnfnetlink.h:218:9
else:
  let IFNAMSIZ* = 16         ## Generated based on /tmp/libnet/libnfnetlink/include/libnfnetlink/libnfnetlink.h:218:9
when 1 is static:
  const
...
when 0 is static:
  const
    NF_DROP* = 0             ## Generated based on /nix/store/sh3sjmgq543lfpjsq3dc0ksb6ckvhpdi-glibc-2.40-66-dev/include/linux/netfilter.h:11:9
else:
  let NF_DROP* = 0           ## Generated based on /nix/store/sh3sjmgq543lfpjsq3dc0ksb6ckvhpdi-glibc-2.40-66-dev/include/linux/netfilter.h:11:9
when 1 is static:
  const
    NF_ACCEPT* = 1           ## Generated based on /nix/store/sh3sjmgq543lfpjsq3dc0ksb6ckvhpdi-glibc-2.40-66-dev/include/linux/netfilter.h:12:9
else:
  let NF_ACCEPT* = 1         ## Generated based on /nix/store/sh3sjmgq543lfpjsq3dc0ksb6ckvhpdi-glibc-2.40-66-dev/include/linux/netfilter.h:12:9
when 2 is static:
  const
    NF_STOLEN* = 2           ## Generated based on /nix/store/sh3sjmgq543lfpjsq3dc0ksb6ckvhpdi-glibc-2.40-66-dev/include/linux/netfilter.h:13:9
else:
  let NF_STOLEN* = 2         ## Generated based on /nix/store/sh3sjmgq543lfpjsq3dc0ksb6ckvhpdi-glibc-2.40-66-dev/include/linux/netfilter.h:13:9
when 3 is static:
  const
    NF_QUEUE* = 3            ## Generated based on /nix/store/sh3sjmgq543lfpjsq3dc0ksb6ckvhpdi-glibc-2.40-66-dev/include/linux/netfilter.h:14:9
else:
  let NF_QUEUE* = 3          ## Generated based on /nix/store/sh3sjmgq543lfpjsq3dc0ksb6ckvhpdi-glibc-2.40-66-dev/include/linux/netfilter.h:14:9
when 4 is static:
  const
    NF_REPEAT* = 4           ## Generated based on /nix/store/sh3sjmgq543lfpjsq3dc0ksb6ckvhpdi-glibc-2.40-66-dev/include/linux/netfilter.h:15:9
else:
  let NF_REPEAT* = 4         ## Generated based on /nix/store/sh3sjmgq543lfpjsq3dc0ksb6ckvhpdi-glibc-2.40-66-dev/include/linux/netfilter.h:15:9
when 5 is static:
  const
    NF_STOP* = 5             ## Generated based on /nix/store/sh3sjmgq543lfpjsq3dc0ksb6ckvhpdi-glibc-2.40-66-dev/include/linux/netfilter.h:16:9
else:
  let NF_STOP* = 5           ## Generated based on /nix/store/sh3sjmgq543lfpjsq3dc0ksb6ckvhpdi-glibc-2.40-66-dev/include/linux/netfilter.h:16:9
when NF_STOP is typedesc:
  type
    NF_MAX_VERDICT* = NF_STOP ## Generated based on /nix/store/sh3sjmgq543lfpjsq3dc0ksb6ckvhpdi-glibc-2.40-66-dev/include/linux/netfilter.h:17:9
else:
  when NF_STOP is static:
    const
      NF_MAX_VERDICT* = NF_STOP ## Generated based on /nix/store/sh3sjmgq543lfpjsq3dc0ksb6ckvhpdi-glibc-2.40-66-dev/include/linux/netfilter.h:17:9
  else:
    let NF_MAX_VERDICT* = NF_STOP ## Generated based on /nix/store/sh3sjmgq543lfpjsq3dc0ksb6ckvhpdi-glibc-2.40-66-dev/include/linux/netfilter.h:17:9
when 255 is static:
  const
    NF_VERDICT_MASK* = 255   ## Generated based on /nix/store/sh3sjmgq543lfpjsq3dc0ksb6ckvhpdi-glibc-2.40-66-dev/include/linux/netfilter.h:22:9
else:
  let NF_VERDICT_MASK* = 255 ## Generated based on /nix/store/sh3sjmgq543lfpjsq3dc0ksb6ckvhpdi-glibc-2.40-66-dev/include/linux/netfilter.h:22:9
when 32768 is static:
  const
    NF_VERDICT_FLAG_QUEUE_BYPASS* = 32768 ## Generated based on /nix/store/sh3sjmgq543lfpjsq3dc0ksb6ckvhpdi-glibc-2.40-66-dev/include/linux/netfilter.h:25:9
else:
  let NF_VERDICT_FLAG_QUEUE_BYPASS* = 32768 ## Generated based on /nix/store/sh3sjmgq543lfpjsq3dc0ksb6ckvhpdi-glibc-2.40-66-dev/include/linux/netfilter.h:25:9
when 4294901760 is static:
  const
    NF_VERDICT_QMASK* = 4294901760'i64 ## Generated based on /nix/store/sh3sjmgq543lfpjsq3dc0ksb6ckvhpdi-glibc-2.40-66-dev/include/linux/netfilter.h:28:9
else:
  let NF_VERDICT_QMASK* = 4294901760'i64 ## Generated based on /nix/store/sh3sjmgq543lfpjsq3dc0ksb6ckvhpdi-glibc-2.40-66-dev/include/linux/netfilter.h:28:9
when 16 is static:
  const
    NF_VERDICT_QBITS* = 16   ## Generated based on /nix/store/sh3sjmgq543lfpjsq3dc0ksb6ckvhpdi-glibc-2.40-66-dev/include/linux/netfilter.h:29:9
else:
  let NF_VERDICT_QBITS* = 16 ## Generated based on /nix/store/sh3sjmgq543lfpjsq3dc0ksb6ckvhpdi-glibc-2.40-66-dev/include/linux/netfilter.h:29:9
when 16 is static:
  const
    NF_VERDICT_BITS* = 16    ## Generated based on /nix/store/sh3sjmgq543lfpjsq3dc0ksb6ckvhpdi-glibc-2.40-66-dev/include/linux/netfilter.h:38:9
else:
  let NF_VERDICT_BITS* = 16  ## Generated based on /nix/store/sh3sjmgq543lfpjsq3dc0ksb6ckvhpdi-glibc-2.40-66-dev/include/linux/netfilter.h:38:9
...
proc pselect*(compiler_nfds: cint; compiler_readfds: ptr fd_set;
    ...
    importc: "pselect".}
proc gettimeofday*(compiler_tv: ptr struct_timeval; compiler_tz: pointer): cint {.
    cdecl, importc: "gettimeofday".}
proc settimeofday*(compiler_tv: ptr struct_timeval;
                   compiler_tz: ptr struct_timezone): cint {.cdecl,
    importc: "settimeofday".}
proc adjtime*(compiler_delta: ptr struct_timeval;
              compiler_olddelta: ptr struct_timeval): cint {.cdecl,
    importc: "adjtime".}
proc getitimer*(compiler_which: compiler_itimer_which_t;
                compiler_value: ptr struct_itimerval): cint {.cdecl,
    importc: "getitimer".}
proc setitimer*(compiler_which: compiler_itimer_which_t;
                compiler_new: ptr struct_itimerval;
                compiler_old: ptr struct_itimerval): cint {.cdecl,
    importc: "setitimer".}
proc utimes*(compiler_file: ptr uint8;
             compiler_tvp: array[2'i64, struct_timeval]): cint {.cdecl,
    importc: "utimes".}
proc lutimes*(compiler_file: ptr uint8;
              compiler_tvp: array[2'i64, struct_timeval]): cint {.cdecl,
    importc: "lutimes".}
proc futimes*(compiler_fd: cint; compiler_tvp: array[2'i64, struct_timeval]): cint {.
    cdecl, importc: "futimes".}
...
var nfq_errno* {.importc: "nfq_errno".}: cint
proc nfq_nfnlh*(h: ptr struct_nfq_handle): ptr struct_nfnl_handle {.cdecl,
    importc: "nfq_nfnlh".}
proc nfq_fd*(h: ptr struct_nfq_handle): cint {.cdecl, importc: "nfq_fd".}
proc nfq_open*(): ptr struct_nfq_handle {.cdecl, importc: "nfq_open".}
proc nfq_open_nfnl*(nfnlh: ptr struct_nfnl_handle): ptr struct_nfq_handle {.
    cdecl, importc: "nfq_open_nfnl".}
proc nfq_close*(h: ptr struct_nfq_handle): cint {.cdecl, importc: "nfq_close".}
proc nfq_bind_pf*(h: ptr struct_nfq_handle; pf: uint16): cint {.cdecl,
    importc: "nfq_bind_pf".}
proc nfq_unbind_pf*(h: ptr struct_nfq_handle; pf: uint16): cint {.cdecl,
    importc: "nfq_unbind_pf".}
proc nfq_create_queue*(h: ptr struct_nfq_handle; num: uint16; cb: nfq_callback;
                       data: pointer): ptr struct_nfq_q_handle {.cdecl,
    importc: "nfq_create_queue".}
proc nfq_destroy_queue*(qh: ptr struct_nfq_q_handle): cint {.cdecl,
    importc: "nfq_destroy_queue".}
proc nfq_handle_packet*(h: ptr struct_nfq_handle; buf: ptr uint8; len: cint): cint {.
    cdecl, importc: "nfq_handle_packet".}
proc nfq_set_mode*(qh: ptr struct_nfq_q_handle; mode: uint8; len: cuint): cint {.
    cdecl, importc: "nfq_set_mode".}
proc nfq_set_queue_maxlen*(qh: ptr struct_nfq_q_handle; queuelen: uint32): cint {.
    cdecl, importc: "nfq_set_queue_maxlen".}
proc nfq_set_queue_flags*(qh: ptr struct_nfq_q_handle; mask: uint32;
                          flags: uint32): cint {.cdecl,
    importc: "nfq_set_queue_flags".}
proc nfq_set_verdict*(qh: ptr struct_nfq_q_handle; id: uint32; verdict: uint32;
                      data_len: uint32; buf: ptr uint8): cint {.cdecl,
    importc: "nfq_set_verdict".}
proc nfq_set_verdict2*(qh: ptr struct_nfq_q_handle; id: uint32; verdict: uint32;
                       mark: uint32; datalen: uint32; buf: ptr uint8): cint {.
    cdecl, importc: "nfq_set_verdict2".}
proc nfq_set_verdict_batch*(qh: ptr struct_nfq_q_handle; id: uint32;
                            verdict: uint32): cint {.cdecl,
    importc: "nfq_set_verdict_batch".}
proc nfq_set_verdict_batch2*(qh: ptr struct_nfq_q_handle; id: uint32;
                             verdict: uint32; mark: uint32): cint {.cdecl,
    importc: "nfq_set_verdict_batch2".}
proc nfq_set_verdict_mark*(qh: ptr struct_nfq_q_handle; id: uint32;
                           verdict: uint32; mark: uint32; datalen: uint32;
                           buf: ptr uint8): cint {.cdecl,
    importc: "nfq_set_verdict_mark".}
proc nfq_get_msg_packet_hdr*(nfad: ptr struct_nfq_data): ptr struct_nfqnl_msg_packet_hdr {.
    cdecl, importc: "nfq_get_msg_packet_hdr".}
proc nfq_get_nfmark*(nfad: ptr struct_nfq_data): uint32 {.cdecl,
    importc: "nfq_get_nfmark".}
proc nfq_get_timestamp*(nfad: ptr struct_nfq_data; tv: ptr struct_timeval): cint {.
    cdecl, importc: "nfq_get_timestamp".}
proc nfq_get_indev*(nfad: ptr struct_nfq_data): uint32 {.cdecl,
    importc: "nfq_get_indev".}
proc nfq_get_physindev*(nfad: ptr struct_nfq_data): uint32 {.cdecl,
    importc: "nfq_get_physindev".}
proc nfq_get_outdev*(nfad: ptr struct_nfq_data): uint32 {.cdecl,
    importc: "nfq_get_outdev".}
proc nfq_get_physoutdev*(nfad: ptr struct_nfq_data): uint32 {.cdecl,
    importc: "nfq_get_physoutdev".}
proc nfq_get_skbinfo*(nfad: ptr struct_nfq_data): uint32 {.cdecl,
    importc: "nfq_get_skbinfo".}
proc nfq_get_uid*(nfad: ptr struct_nfq_data; uid: ptr uint32): cint {.cdecl,
    importc: "nfq_get_uid".}
proc nfq_get_gid*(nfad: ptr struct_nfq_data; gid: ptr uint32): cint {.cdecl,
    importc: "nfq_get_gid".}
proc nfq_get_secctx*(nfad: ptr struct_nfq_data; secdata: ptr ptr uint8): cint {.
    cdecl, importc: "nfq_get_secctx".}
proc nfq_get_indev_name*(nlif_handle: ptr struct_nlif_handle;
                         nfad: ptr struct_nfq_data; name: ptr uint8): cint {.
    cdecl, importc: "nfq_get_indev_name".}
proc nfq_get_physindev_name*(nlif_handle: ptr struct_nlif_handle;
                             nfad: ptr struct_nfq_data; name: ptr uint8): cint {.
    cdecl, importc: "nfq_get_physindev_name".}
proc nfq_get_outdev_name*(nlif_handle: ptr struct_nlif_handle;
                          nfad: ptr struct_nfq_data; name: ptr uint8): cint {.
    cdecl, importc: "nfq_get_outdev_name".}
proc nfq_get_physoutdev_name*(nlif_handle: ptr struct_nlif_handle;
                              nfad: ptr struct_nfq_data; name: ptr uint8): cint {.
    cdecl, importc: "nfq_get_physoutdev_name".}
proc nfq_get_packet_hw*(nfad: ptr struct_nfq_data): ptr struct_nfqnl_msg_packet_hw {.
    cdecl, importc: "nfq_get_packet_hw".}
proc nfq_get_payload*(nfad: ptr struct_nfq_data; data: ptr ptr uint8): cint {.
    cdecl, importc: "nfq_get_payload".}
proc nfq_snprintf_xml*(buf: ptr uint8; len: csize_t; tb: ptr struct_nfq_data;
                       flags: cint): cint {.cdecl, importc: "nfq_snprintf_xml".}
proc nfq_nlmsg_cfg_put_cmd*(nlh: ptr struct_nlmsghdr; pf: uint16; cmd: uint8): void {.
    cdecl, importc: "nfq_nlmsg_cfg_put_cmd".}
proc nfq_nlmsg_cfg_put_params*(nlh: ptr struct_nlmsghdr; mode: uint8;
                               range: cint): void {.cdecl,
    importc: "nfq_nlmsg_cfg_put_params".}
proc nfq_nlmsg_cfg_put_qmaxlen*(nlh: ptr struct_nlmsghdr; qmaxlen: uint32): void {.
    cdecl, importc: "nfq_nlmsg_cfg_put_qmaxlen".}
proc nfq_nlmsg_verdict_put*(nlh: ptr struct_nlmsghdr; id: cint; verdict: cint): void {.
    cdecl, importc: "nfq_nlmsg_verdict_put".}
proc nfq_nlmsg_verdict_put_mark*(nlh: ptr struct_nlmsghdr; mark: uint32): void {.
    cdecl, importc: "nfq_nlmsg_verdict_put_mark".}
proc nfq_nlmsg_verdict_put_pkt*(nlh: ptr struct_nlmsghdr; pkt: pointer;
                                pktlen: uint32): void {.cdecl,
    importc: "nfq_nlmsg_verdict_put_pkt".}
proc nfq_nlmsg_parse*(nlh: ptr struct_nlmsghdr; attr: ptr ptr struct_nlattr): cint {.
    cdecl, importc: "nfq_nlmsg_parse".}
proc nfq_nlmsg_put*(buf: ptr uint8; type_arg: cint; queue_num: uint32): ptr struct_nlmsghdr {.
    cdecl, importc: "nfq_nlmsg_put".}
